...
def main_program(super_user,hoja):
    ...
    def check_export():
        ...
        def search_df():
            ...
            matches = dfpartes[(dfpartes['No Parte'] == search_num) & (dfpartes['Destino'] == "Mexico-Estados Unidos")]
            matches2 = dfpartes[(dfpartes['No Parte'] == search_num) & (dfpartes['Destino'] == "Estados Unidos-Mexico")]
    ...
    tk.Label(main_window, text='Ver.10 Ago/2023',font=("Courier 6 bold"),fg="black").place(x=210,y=2)        
    # Add button

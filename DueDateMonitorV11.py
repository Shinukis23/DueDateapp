    ...
    def Actualizacion():
        ...
        while True:
            ...
            if control == 1:
                ...
                T_Cambio = tk.Label(main_window,font=("times", 10, "bold"),fg="green",text=Tipo_Cambio).place(x=263,y=16)
                control = 0
            else :    
                #T_Cambio = tk.Label(main_window,font=("times", 10, "bold"),fg="red",text=Tipo_Cambio).place(x=270,y=16)
                T_Cambio = tk.Label(main_window,font=("times", 10, "bold"),fg="red",text=Tipo_Cambio).place(x=263,y=16)
...
###            
    ...
    Cambio = tk.Label(main_window,font=("times", 10, "bold"),fg="black",text="Tipo_Cambio: ").place(x=187,y=16)
    T_Cambio = tk.Label(main_window,font=("times", 10, "bold"),fg="red",text=Tipo_Cambio).place(x=263,y=16)
    #name = Label(main_window,font=("Courier 9 bold"), text = DOF).place(x = 14,y = 4)
    tk.Label(main_window, text='Ver.11 Ago/2023',font=("Courier 6 bold"),fg="black").place(x=210,y=2)        
    # Add button
